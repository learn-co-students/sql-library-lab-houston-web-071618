...
-- INSERT INTO series (id, title, author_id, subgenre_id) VALUES (1, 'Harry Potter Series', 1, 1), (2, 'Animal Farm Series', 2, 2);
--
-- INSERT INTO subgenres (id, name) VALUES (1, 'fantasy'), (2, 'mystery');
--
-- INSERT INTO authors (id, name) VALUES (1, 'JK Rowling'), (2, 'George Orwell');
--
-- INSERT INTO books (id, title, year, series_id) VALUES (1, 'Sorcerors Stone', 2000, 1), (2, 'Chamber of Secrets', 2001, 2), (3, 'Prisoner of Azkaban', 2002) (4, 'First Book', 1990), (5, 'Second Book', 1991), (6, 'Third Book', 1992);

--
-- INSERT INTO characters (id, title, author_id, subgenre_id) VALUES (1, 'Harry Potter', 1, 1), (2, 'Animal Farm', 2, 2);
